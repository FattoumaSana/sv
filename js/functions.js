    ...
    formAjaxProcessing: function () {
      ...
      if ($ajaxForm.length > 0) {
        $ajaxForm.each(function () {
          var elem = $(this),
            elemSuccessMessage = elem.attr("data-success-message") || "Nous avons <strong> reçu avec succès </strong> votre message et vous répondrons dans les plus brefs délais",
          ...
          elem.submit(function (event) {
            ...
            if (elem[0].checkValidity() === false) {
              ...
              button.html('<i class="icon-loader fa-spin"> </i> En cours d envoi')
              $.ajax({
                url: post_url,
                type: request_method,
                data: form_data,
