...
$to = 'fs.benissia@gmail.com';

// Add your reCaptcha Secret key if you wish to activate google reCaptcha security
$recaptcha_secret_key = '6LdGS8YZAAAAAN3I7OjN2sy4nkyndiUTn88ELtsU'; 
...
$form_title	= isset($_POST["form-name"]) ? $_POST["form-name"] : "Contact Support Partenaire";
$subject = isset($_POST[$form_prefix."subject"]) ? $_POST[$form_prefix."subject"] : 'Nouveau message: Contact Support Partenaire Media Technologie';
...
$n_client = isset($_POST[$form_prefix."n_client"]) ? $_POST[$form_prefix."n_client"] : null;
$subject2 = isset($_POST[$form_prefix."subject"]) ? $_POST[$form_prefix."subject"] 
...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($email != '') {
        ...
        $mail_template .= '<tr><td style="padding-top:20px;padding-left:0px;padding-right:0px;width:100%;text-align:right; font-size:12px;line-height:22px">Nouveau Message de&nbsp;'.$_SERVER['HTTP_HOST'].'</td></tr>';
        ...
        if(!empty($recaptcha_secret_key) && isset($_POST['g-recaptcha-response'])) {
            ...
            if ($response_data->success !== true ) {
                $response = array ('response'=>'error', 'message'=> "Captcha Google n'est pas valide! Veuillez réessayer");
